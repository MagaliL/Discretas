...
preguntas[40]=new pregunta("¿Cómo se define el residuo en aritmética residual?","Como el sobrante de dividir dos números","Como la diferencia de dos números","Como el producto de dos números","Como la suma de dos números",0);
preguntas[41]=new pregunta("¿Cuál es una característica del cifrado RSA?","Usa una sola clave para cifrar y descifrar","Usa una clave pública y otra privada","Basado en el cifrado César","No utiliza la aritmética modular",1);
preguntas[42]=new pregunta("¿Qué no es un ejemplo de aplicación de criptografía?","Protección de datos personales","Enviar mensajes secretos","Enviar cosas no cifradas","Seguridad en transacciones bancarias",2);
preguntas[43]=new pregunta("¿Por qué no existe el inverso modular de 2 (mod 4)?","Porque 2 es mayor que 4","Porque 2 es menor que 4","Porque 2 y 4 no son primos relativos","Porque 2 y 4 son múltiplos",2);
preguntas[44]=new pregunta("¿Cómo se denota la congruencia entre dos números enteros en la aritmética modular?","a ≡ b modm","a ≅ b modm","a ≡ b (modm)","a ≅b(modm)",2);
preguntas[45]=new pregunta("¿Qué teorema es crucial en la aritmética modular?","Teorema de pitágoras","Teorema chino de los restos","Teorema de Fermat","Teorema de Euler",1);
...
preguntas[47]=new pregunta("¿Cuál es una característica de los sistemas numéricos posicionales?","No usan el número 0","Usan una base fija","El valor de un símbolo depende de su posición","Representan cantidades negativas únicamente",2);
preguntas[48]=new pregunta("¿Con qué otro nombre se le conoce a la Aritmética de Residuos?","Aritmética de sobras","Aritmética Modular o de Congruencia","Aritmética Algebraica","Aritmética Proposicional",1);
preguntas[49]=new pregunta("¿Cómo se denota la congruencia entre dos números enteros en la aritmética modular?","a ≡ b modm","a ≅ b modm","a ≡ b (modm)","a ≅b(modm)",2);
preguntas[50]=new pregunta("¿Qué números encontró Sun Zi que son múltiplos de 57, de 37 y de 3*5 respectivamente para resolver el problema?","50, 21, 15","70, 21, 15","70, 27, 35","35, 42, 15",1);
